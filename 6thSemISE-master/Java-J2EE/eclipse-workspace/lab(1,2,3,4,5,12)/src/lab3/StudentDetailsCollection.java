...
public class StudentDetailsCollection {
	...
	public StudentDetailsCollection(String name, String usn, int age, String address, String category, float s1, float s2, float s3, float s4, float s5, float s6, float s7, float s8, float cgpa) {
		this.name = name;
		this.usn = usn;
		this.age = age;
