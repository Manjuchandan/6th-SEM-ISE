 ...
 public static void main(String[] args) {
   ...
   jb1.addActionListener(new ActionListener() {
     ...
     public void actionPerformed(ActionEvent e) { // anonymous inner class
       ...
       try {
         Class.forName("com.mysql.cj.jdbc.Driver"); // registers and loads the driver.
         Connection conn = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/Jdbc", "root", "Manju@123");
         if (conn != null) {
